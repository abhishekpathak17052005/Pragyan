...
export class Phase7FinalReportService {
    ...
    await prisma.assessmentSession.create({
      data: {
        ...
        analysis: JSON.stringify({
          userSummary: finalReport.userSummary,
          assessmentSummary: finalReport.assessmentSummary,
          ...
          resources: finalReport.resources,
          projects: finalReport.projects,
          finalAdvice: finalReport.finalAdvice,
  ...
  async getReport(userId: string): Promise<Phase7AIReport | null> {
    ...
    return {
      userSummary: {
        profileOverview: analysis.userSummary?.profileOverview || analysis.profileOverview || 'No summary available',
        education: analysis.userSummary?.education || analysis.education || 'Not specified',
        careerGoal: analysis.userSummary?.careerGoal || analysis.careerGoal || 'Not specified',
      },
      assessmentSummary: {
        cognitiveAnalysis: analysis.assessmentSummary?.cognitiveAnalysis || analysis.cognitiveAnalysis || '',
        technicalAnalysis: analysis.assessmentSummary?.technicalAnalysis || analysis.technicalAnalysis || '',
        domainAnalysis: analysis.assessmentSummary?.domainAnalysis || analysis.domainAnalysis || '',
        specializationAnalysis: analysis.assessmentSummary?.specializationAnalysis || analysis.specializationAnalysis || '',
      },
      ...
      personalizedRoadmap: {
        ...
        milestones: analysis.personalizedRoadmap?.milestones || [],
      },
      certifications: analysis.certifications || [],
      resources: analysis.resources || [],
      projects: analysis.projects || [],
      finalAdvice: analysis.finalAdvice || 'Continue building your skills and gaining practical experience.',
      nextSteps: analysis.nextSteps || ['Complete your personalized roadmap', 'Build portfolio projects', 'Apply for internships'],
