...
export function Auth() {
  ...
  useEffect(() => {
    ...
    const oauthMessages: Record<string, string> = {
      oauth_cancelled: "OAuth login was cancelled. Please try again.",
      invalid_callback: "Invalid OAuth callback. Please retry login.",
      missing_email: "Your OAuth account does not provide a usable email address.",
      provider_failure: "OAuth provider failed to authenticate your account.",
      token_generation_failed: "Authentication completed but token generation failed. Please try again.",
    };

    setError(oauthMessages[errorCode] || "Unable to complete OAuth sign-in.");
  }, [location.search]);
